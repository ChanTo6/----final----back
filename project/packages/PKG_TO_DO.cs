        ...
        public async Task<List<ProjectUser>> GetAllProjectUsersAsync()
        {
            ...
            try
            {
                using (OracleConnection conn = new OracleConnection(Connstr))
                {
                    ...
                    using (OracleCommand cmd = new OracleCommand("PROJECT_pkg.get_all_users", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task UpdateUserByPersonId(int personId, string employeeName, string employeeSurname, string password, string role, string telephone, string orgName, string warehouse)
        {
            ...
            try
            {
                using (OracleConnection conn = new OracleConnection(Connstr))
                {
                    ...
                    using (OracleCommand cmd = new OracleCommand("PROJECT_pkg.upd_user_by_id", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        {
                            cmd.Parameters.Add("p_warehouse", OracleDbType.Varchar2).Value = DBNull.Value;
                        }
                        else
                        {
            ...
            List<Claim> claims = new List<Claim>
    {
        ...
        public async Task EditProductInWarehouse(string ProductName, string Barcode, int ProductId, int Quantity, int UserId)
        {
            try
            {
                using (var conn = new OracleConnection(Connstr))
                {
                    ...
                    using (var cmd = new OracleCommand("PROJECT_pkg.edit_prod_in_warehouse", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<Product>> FetchProductbyuserId(int userId)
        {
            ...
            try
            {
                ...
                {
                    await conn.OpenAsync();
                    using (var cmd = new OracleCommand("PROJECT_pkg.get_user_prods", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<Product>> FetchProducts()
        {
            ...
            try
            {
                using (var conn = new OracleConnection(Connstr))
                {
                    ...
                    using (var cmd = new OracleCommand("PROJECT_pkg.FetchAllProducts", conn))
                    {
                        ...
                        // Get the data reader from the REF CURSOR
                        using (var reader = ((OracleRefCursor)pResultSet.Value).GetDataReader())
                        {
                            while (await reader.ReadAsync())
                            {
                                ...
                                products.Add(new Product
                                {
                                    ProductId = reader.IsDBNull(0) ? 0 : reader.GetInt32(0), // Handle NULL for product_id
                                    userId = reader.IsDBNull(1) ? 0 : reader.GetInt32(1),   // Handle NULL for user_id
                                    ProductName = reader.IsDBNull(2) ? string.Empty : reader.GetString(2), // Handle NULL for product_name
                                    quantity = reader.IsDBNull(3) ? 0 : reader.GetInt32(3), // Handle NULL for quantity
                                    barcode = reader.IsDBNull(4) ? string.Empty : reader.GetString(4), // Handle NULL for barcode
                                    Role = reader.IsDBNull(5) ? string.Empty : reader.GetString(5)  // Handle NULL for role
                                });
                            }
                        }
                    }
            ...
            {
                Console.WriteLine(product); // Ensure you have a suitable ToString() method in your Product class
            }
        ...
        public async Task<List<Product>> GetRemovedProductsByUserId(int userId)
        {
            ...
            try
            {
                using (var conn = new OracleConnection(Connstr))
                {
                    ...
                    using (var cmd = new OracleCommand("PROJECT_pkg.get_removed_prods", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        var pUserId = new OracleParameter("p_user_id", OracleDbType.Int32)
                        {
        ...
        public async Task AddProductToWarehouse(string productName, int quantity, int userId, string warehouseName, string location)
        {
            ...
            try
            {
                using (var conn = new OracleConnection(Connstr))
                {
                    ...
                    using (var cmd = new OracleCommand("PROJECT_pkg.add_prod_to_warehouse", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<WarehouseInfo>> CheckFreeSeatsByUserIdAsync(int userId)
        {
            ...
            try
            {
                ...
                {
                    await conn.OpenAsync();
                    using (OracleCommand cmd = new OracleCommand("PROJECT_pkg.check_free_seats", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("p_user_id", OracleDbType.Int32).Value = userId;
